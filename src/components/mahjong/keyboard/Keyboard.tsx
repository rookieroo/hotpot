...
import { ENTER_TEXT, DELETE_TEXT, CLEAR_TEXT } from '../constants/strings'
...
export const Keyboard = ({ onChar, onDelete, onEnter, onClear, guesses }: Props) => {
  ...
  return (
    <div>
      ...
      <div className="flex justify-center sm:text-3xl text-2xl">
        ...
        <div className="text-xs">
          <Key width={50} value="CLEAR" onClick={onClick}>
            {CLEAR_TEXT}
          </Key>
        </div>
      </div>
